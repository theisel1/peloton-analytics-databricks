...
def run_lakehouse(
    ...
    return {
        ...
        "baseline_mae": float(train_result["baseline_mae"]),
        "baseline_r2": float(train_result["baseline_r2"]),
        "mae_improvement_vs_baseline": float(train_result["mae_improvement_vs_baseline"]),
        "r2_improvement_vs_baseline": float(train_result["r2_improvement_vs_baseline"]),
        "split_type": str(train_result["split_type"]),
